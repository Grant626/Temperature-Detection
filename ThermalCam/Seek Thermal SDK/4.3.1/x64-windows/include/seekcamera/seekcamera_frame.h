...
typedef struct seekcamera_frame_header_t
{
	...
	float linear_agc_min;						// Minimum count value in the frame when using Linear AGC.
	float linear_agc_max;						// Maximum count value in the frame when using Linear AGC.
