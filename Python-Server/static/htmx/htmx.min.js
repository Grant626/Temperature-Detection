(function (e, t) {
  ...
  return (function () {
    ...
    function et(t, r, e) {
      if (
        (t.tagName === 'A' && Qe(t) && (t.target === '' || t.target === '_self')) ||
        t.tagName === 'FORM'
      ) {
        r.boosted = true;
        var n, i;
    ...
    function qr(l, u) {
      ...
      var o = se({ shouldSwap: i, serverResponse: v, isError: a, ignoreTitle: g }, u);
        ...
        var x = function () {
          try {
            ...
            var s = function () {
              ...
              if (d.type) {
                fe(te().body, 'htmx:beforeHistoryUpdate', se({ history: d }, u));
                if (d.type === 'push') {
                  $t(d.path);
